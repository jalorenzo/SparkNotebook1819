...
export SPARK_SUBMIT_OPTIONS="--packages graphframes:graphframes:0.1.0-spark1.6"
...
#export PYSPARK_PYTHON=/opt/spark/bin/          		# path to the python command. must be the same path on the driver(Zeppelin) and all workers.
# export PYTHONPATH
